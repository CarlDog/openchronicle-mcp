...
from ..interfaces.performance_interfaces import IMetricsStorage, PerformanceMetrics, MetricsQuery
...
class MetricsStorage(IMetricsStorage):
    ...
    async def initialize(self):
        ...
        try:
            ...
            log_system_event("metrics_storage", "Storage initialized", {
    ...
    async def store_metrics(self, metrics: PerformanceMetrics):
        ...
        try:
            ...
            log_system_event("metrics_storage", "Metrics stored", {
    ...
    async def retrieve_metrics(self, query: MetricsQuery) -> List[PerformanceMetrics]:
        ...
        try:
            ...
            log_system_event("metrics_storage", "Metrics retrieved", {
    ...
    async def get_metrics_summary(self, time_period: Tuple[datetime, datetime],
        ...
        try:
            ...
            adapter_query = """
                ...
                WHERE start_time >= ? AND end_time <= ?
            """
            adapter_params: List[Any] = [time_period[0].timestamp(), time_period[1].timestamp()]
    ...
    async def cleanup_old_metrics(self, retention_days: int = 30) -> int:
        ...
        try:
            ...
            log_system_event("metrics_storage", "Old metrics cleaned up", {
