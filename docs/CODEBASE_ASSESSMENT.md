...
**Snapshot date:** 2026-08-17 · **Revision:** 78
...
| Main vs deployed | In sync at rc8. Code goes live only when the stack's `OC_TAG` env moves — a push alone deploys nothing |
