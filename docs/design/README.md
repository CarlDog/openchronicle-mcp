...
| [0005 — Composite embedding identity](0005-embedding-identity.md) | ADR | **Proposed (rev 2)** — rev 1 rewritten after a three-critic adversarial review; awaiting operator acceptance; unblocks 0003 Phases C/D |
