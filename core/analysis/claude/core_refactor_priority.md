...
based on this document, select a script to perform an analysis on and look for refactoring potential and deduplication of code. be sure to select one that you feel capable of tackling. we'll create a recommendations document for each of the files. we will store it within the 'core\analysis\claude\*' folder.
