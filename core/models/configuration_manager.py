...
from core.registry.registry_manager import RegistryManager
from core.shared.centralized_config import SystemConfig, ModelConfig
from core.registry.schema_validation import validate_provider_config
...
class ConfigurationManager:
    ...
    def __init__(self, config_path: str = "config"):
        ...
        log_system_event("configuration_manager_initialized", 
    ...
    def _discover_models(self) -> Dict[str, Any]:
        ...
        try:
            ...
            log_system_event("models_discovered", 
    ...
    def get_configuration_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "enabled_models": len([name for name, config in adapters.items() 
    ...
    def get_enabled_models_by_type(self, model_type: str = "text") -> List[Dict[str, Any]]:
        ...
        for model_name, model_config in self.list_model_configs().items():
            if (model_config.get("type") == model_type and 
