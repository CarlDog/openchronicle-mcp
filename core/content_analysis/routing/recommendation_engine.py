...
class RecommendationEngine(RoutingComponent):
    ...
    def _suggest_model_management_actions_sync(self, content_type: str, system_resources: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            missing_api_models = [name for name in api_models if name in all_models and len(working_analysis_models) < 3]
    ...
    def _get_system_state(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "available_adapters": getattr(self.model_manager, 'get_available_adapters', lambda: [])(),
