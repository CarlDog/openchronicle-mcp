...
from ..shared import (
    TokenUsageRecord, TokenUsageType, StatisticsCalculator, 
    TokenManagerException, CacheManager
)
...
class UsageTracker:
    ...
    def track_token_usage(self, model_name: str, prompt_tokens: int, 
                         ...
                         cost: float = 0.0, metadata: Optional[Dict[str, Any]] = None):
...
class CostCalculator:
    ...
    def calculate_cost(self, model_name: str, prompt_tokens: int, response_tokens: int,
                      custom_rates: Optional[Dict[str, float]] = None) -> float:
    ...
    def estimate_cost(self, model_name: str, estimated_tokens: int,
                     custom_rates: Optional[Dict[str, float]] = None) -> float:
    ...
    def get_cost_comparison(self, models: List[str], token_count: int,
                           custom_rates: Optional[Dict[str, float]] = None) -> Dict[str, float]:
