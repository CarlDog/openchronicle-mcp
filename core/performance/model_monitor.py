...
try:
    from utilities.performance_monitor import PerformanceMonitor as UtilityPerformanceMonitor
...
class PerformanceMonitor:
    ...
    def _initialize_performance_monitoring(self):
        ...
        try:
            if PERFORMANCE_MONITOR_AVAILABLE:
                ...
                log_system_event("performance_monitoring_disabled", "Performance monitoring disabled - utilities not available")
                self.monitoring_enabled = False
    ...
    async def optimize_model_performance(self, adapter_name: Optional[str] = None) -> Dict[str, Any]:
        """
