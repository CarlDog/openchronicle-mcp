...
from .mechanics_models import (
    DiceType, DiceRoll, ResolutionResult, ResolutionConfig,
    DifficultyLevel, OutcomeType, ResolutionType
)
...
class DiceEngine:
    ...
    def __init__(self, config: Optional[ResolutionConfig] = None):
        ...
        log_system_event("dice_engine_initialized", f"Dice engine ready with {self.config.dice_type.value} dice")
