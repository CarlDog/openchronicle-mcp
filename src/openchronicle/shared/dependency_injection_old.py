...
class DIContainer:
    ...
    def register(
        ...
        log_info(
            f"Registered service: {interface.__name__} -> {implementation} ({lifetime})"
        )
    ...
    def register_instance(
        self, interface: Type[T], instance: T, description: str = ""
    ) -> "DIContainer":
        ...
        log_info(
            f"Registered instance: {interface.__name__} -> {type(instance).__name__}"
        )
        ...
        for param_name in param_names:
            ...
            if param.annotation != inspect.Parameter.empty:
                try:
                    ...
                    log_warning(
                        f"Could not resolve dependency {param.annotation.__name__} for {cls.__name__}"
                    )
                    pass
