...
class AsyncDatabaseOrchestrator:
    ...
    def get_sync_operations(self):
        """Get synchronous operations for backwards compatibility."""
...
def get_async_database_orchestrator() -> AsyncDatabaseOrchestrator:
    """Get global async database orchestrator instance."""
    global _async_orchestrator
    if _async_orchestrator is None:
        _async_orchestrator = AsyncDatabaseOrchestrator()
    return _async_orchestrator


# Async utility functions for backwards compatibility
...
async def async_execute_update(
    ...
    orchestrator = get_async_database_orchestrator()
    return await orchestrator.execute_update(story_id, query, params, is_test)
