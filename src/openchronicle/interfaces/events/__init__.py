...
class ConnectionManager:
    ...
    async def connect(self, websocket: WebSocket, client_id: str, 
                     subscriptions: Optional[List[EventType]] = None) -> str:
    ...
    async def broadcast(self, event: Event, event_type_filter: Optional[EventType] = None):
...
class EventBus:
    ...
    def get_recent_events(self, event_types: Optional[List[EventType]] = None, 
...
class BackgroundTaskManager:
    ...
    def add_periodic_task(self, task_id: str, coro_func: Callable, 
                         interval: int, immediate: bool = False):
    ...
    async def get_event_stats():
        ...
        return {
            ...
            "background_tasks": {
                ...
                for task_id, info in (event_app.background_manager.periodic_tasks.items() 
                                    if event_app.background_manager else {}).items()
            }
        }
