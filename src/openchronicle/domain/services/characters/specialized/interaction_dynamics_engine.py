...
from ..core.character_data import CharacterInteraction
from ..core.character_data import CharacterInteractionType
from ..core.character_data import CharacterRelationship
from ..core.character_data import CharacterRelationType
from ..core.character_data import CharacterState
from ..core.character_data import SceneState
...
class InteractionDynamicsEngine(CharacterEngineBase, CharacterStateProvider):
    ...
    def process_interaction(
        ...
        speaker_id: str,
        content: str,
        interaction_type: CharacterInteractionType = CharacterInteractionType.DIALOGUE,
