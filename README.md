...
**OpenChronicle** is a modular, AI-powered interactive storytelling engine built to support dynamic worldbuilding, persistent memory, character-driven narratives, and multi-model orchestration — all within a portable, Docker-ready framework.
...
> 🚧 This project is under active development. The following setup steps are **in progress** for v0.1 release.

### 🐳 Docker Quick Start

```bash
# Clone the repo (private for now)
git clone git@github.com:OpenChronicle/openchronicle-core.git
cd openchronicle-core

# Build the container
docker build -t openchronicle .
