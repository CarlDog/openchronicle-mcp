...
class ModelListCommand(ModelCommand):
    ...
    def execute(self, provider: Optional[str] = None, status: Optional[str] = None) -> List[Dict[str, Any]]:
...
def list_models(
    ...
    model_type: Optional[str] = typer.Option(None, "--type", "-t", help="Filter by type (text/image)"),
    ...
    try:
        ...
        if models:
            ...
            if models:
                ...
                output_manager.warning(f"No models found matching filters")
        else:
...
def test_models(
    ...
    provider: Optional[str] = typer.Option(None, "--provider", "-p", help="Test all models for provider"),
...
def configure_provider(
    ...
    model: Optional[str] = typer.Option(None, "--model", help="Default model for provider"),
...
def benchmark_models(
    models: Optional[List[str]] = typer.Option(None, "--models", help="Specific models to benchmark"),
