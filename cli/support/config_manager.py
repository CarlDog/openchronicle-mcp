...
class ConfigManager:
    ...
    def add_recent_file(self, file_path: Union[str, Path], max_recent: int = 10):
        """
    ...
    def export_settings(self, export_path: Union[str, Path]):
        """
    ...
    def import_settings(self, import_path: Union[str, Path], merge: bool = True):
        """
