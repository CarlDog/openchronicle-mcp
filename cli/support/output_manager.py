...
class OutputManager:
    ...
    def error(self, message: str, error: Optional[Exception] = None, exit_code: int = 1):
    ...
    def table(self, data: List[Dict[str, Any]], title: str = "", headers: Optional[List[str]] = None):
    ...
    def _build_tree(self, tree: Tree, data: Union[Dict, List, Any], max_depth: int = 3, current_depth: int = 0):
